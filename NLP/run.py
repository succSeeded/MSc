    ...
    with open(infile, "r", encoding="utf8") as fin:
        ...
        for line in fin:
            ...
            if len(splitted) == 10:
                ...
                raise ValueError(f"Each line should have 9 or 10 columns. Got {len(splitted)}")
            if tags[1] != "_":
...
VALUE_ALIASES = {'INFN': ["Inf"], 'Inf': ["INFN"], 'Brev': ["Short", "Brev"], 'Short': ["Short", "Brev"], 'Notpast': ["Pres", "Fut"], 'NumForm': ["Form"]}
...
if __name__=='__main__':
    ...
    parser.add_argument("textpath", action='store', help="Path to the text to be parsed.")
